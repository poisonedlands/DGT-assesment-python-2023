...
def main():
    ...
    while True:
        ...
        Wulf_BUTTON = Button(image=pygame.image.load("Play Rect.png"), pos=(380, 600),
                            text_input="Wulf", font=get_font(75), base_color="#d7fcd4", hovering_color="Gold")
        
        Heidi_BUTTON = Button(image=pygame.image.load("Play Rect.png"), pos=(900, 600),
...
def Heidi_room():
    ...
    while True:
        ...
        YES_BUTTON = Button(image=pygame.image.load("Play Rect.png"), pos=(380, 600),
                            text_input="Yes", font=get_font(75), base_color="#d7fcd4", hovering_color="Gold")
        
        NO_BUTTON = Button(image=pygame.image.load("Play Rect.png"), pos=(900, 600),
...
def room_1():
    ...
    while True:
        ...
        CONTINUE_BUTTON = Button(image=pygame.image.load("Play Rect.png"), pos=(640, 600),
